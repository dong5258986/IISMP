	...
	$.ajax({
		...
		success:function(data) {
			...
			if(str.isempty==false){
				...
				$.each(str.jsona, function() {
					/*var div="<div class='a'/>";
					var h1 = "<h4>"+this.announcement_title+"</h4>";
					var p1 = "<p>"+this.announcement_info+"</p>";
					var th1="<th>"+this.m_username+"&nbsp"+"</th>";
					var th2="<th>"+"发布与 "+this.announcement_time+"</th>";
					var th3="<th>"+this.announcement_views+"&nbsp"+"次浏览"+"</th>";
					var div1="</div>";
					var br="<br>";*/
					var t1 = '<a href="findAinfobyid?announcement_id='+this.announcement_id+'" style="text-decoration: none;">	';
					var t2 = '<div class="a"><h4 style="color: #666666;margin-left: 10px;margin-right: 10px;">'+this.announcement_title;
					var t3 = '</h4><p style="color: #adadad;margin-left: 20px;margin-right: 20px;" >'+this.announcement_info+'</p>';
						
					var t4 = '<p style="color: #adadad;margin-left: 20px;margin-right: 20px;">';
					var t5 = this.m_username+'&nbsp; 发布与 '+this.announcement_time+'&nbsp;/&nbsp;'+this.announcement_views+'次浏览';
					var t6 = '</p><br></div></a><br>';
					thisstr = thisstr+t1+t2+t3+t4+t5+t6;
				//thisstr = thisstr + "<a href='findAinfobyid?announcement_id="+this.announcement_id+" ' style='text_decoration: none;'/>"+br+div+h1+p1+th1+th2+th3+br+div1+br+"</a>";
				});
				$("#ssbody").html(thisstr);
				...
				var thisstr="";
				var a1="<a href='findAinfobyid?announcement_id="+this.announcement_id+"' />";
				var div="<div class='a'/>";
				var h1 = "<h4>"+"暂无任务"+"</h4>";
				var br="<br/>";
				thisstr = thisstr + "<div>"+a1+br+div+br+h1+"</div>";
				document.getElementById('tbody').innerHTML=thisstr;
			}
			spinnerend();
		},
		error:function(data) {
