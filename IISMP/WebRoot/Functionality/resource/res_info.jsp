...
List<ResourceInfo> re=(List<ResourceInfo>)request.getAttribute("resourceInfo");
List<Resource_Type> rt=(List<Resource_Type>)session.getAttribute("Resource_Type");
								        ...
								        <div class="form-group">
							             ...
							             <div class="form-group" >
										    ...
										    <div class="form-group" style="display:none">
										     <input name="rt_id"   id="rttid"	value="<%=rtt.getRt_id() %>" >
					...
					<div class="col-md-12 column" style="overflow-x:hidden; height:495px; ">
						...
						%>
							<tr>
								...
								<td class="p13-999"><%=rk.getResource_issuer()%></td>
								<td class="p13-999"><%=rk.getResource_time() %></td>
								<td>
								
									<a style="text-decoration: none;"  href="downloadFile2?filename=<%=rk.getResource_name() %>" role="button" class="btn btn-xs" >
										<img src="img/down.png"  data-toggle="tooltip" data-placement="bottom" title="下载"/>
									</a>
									<a style="text-decoration: none;"  href="javascript:void(0);"  onclick="deleteRebyid(<%=rk.getResource_id() %>)"  class="btn btn-xs">
