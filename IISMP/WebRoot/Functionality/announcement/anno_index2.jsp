...
List<Announcement> announcement1= (List<Announcement>)request.getAttribute("announce1");
				...
				<div class="col-md-9 column" style="-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);border:#EDEFF0 solid;border-width:5px; background-color: #FFFFFF;">
					<h4 style="margin-top:10px;">
						...
						<span class="navbar-right" style="margin-right: 5px;">
							 <button type="button" class="btn btn-info btn-xs" onclick="findasid1()">已发布（）</button>
							 <button type="button" class="btn btn-info btn-xs" onclick="findasid()">未发布(<%=announcement1.size() %>)</button>
						</span>							 
					</h4>
