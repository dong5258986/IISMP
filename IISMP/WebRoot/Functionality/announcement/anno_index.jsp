...
List<Announcement> announcement= (List<Announcement>)session.getAttribute("announcement");
			...
			<div class="col-md-9 column" style="-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);border:#EDEFF0 solid;border-width:5px; background-color: #FFFFFF;">
				...
				<div style="overflow-x:hidden; height:498px; ">
					...
					<table class="table table-hover" style="font-size: 13px;">
						...
						%>
							<tr>
								<td><a href="javascript:void(0);" data-toggle="modal" onclick="findthisannouncementinfo(<%=an.getAnnouncement_id() %>);" data-target="#modal-container-722522"><%=an.getAnnouncement_title() %></a></td>
								...
								<td style="cursor:pointer;">
								  ...
								  <a  href="editAnnoByid?announcement_id=<%=an.getAnnouncement_id() %>" style="text-decoration: none;">
								     <img src="img/edit.png"  data-toggle="tooltip" data-placement="bottom" title="编辑"/></a>&nbsp;<a href="javascript:void(0);"  onclick="deletethisannounbyid(<%=an.getAnnouncement_id() %>);" style="text-decoration: none;">
