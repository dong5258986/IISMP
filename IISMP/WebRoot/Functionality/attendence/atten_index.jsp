	...
	$(document).ready(function () {
		...
		$.ajax({   
	        ...
	        success:function(data) {
	        	...
	        	var str = eval("("+data+")");
	        	if(str.isCheckin){
	        		checkin = "<span style='color: #999'>已签到 &nbsp;&nbsp;<font style='font-weight:bold;'>" + str.check_in_time + "</font></span>";
	        	...
	        	if(str.isCheckout){
	        		checkout = "<span style='color: #999'>已签退 &nbsp;&nbsp;<font style='font-weight:bold;'>" + str.check_out_time + "</font></span>";
	        	}else {
	        	}
