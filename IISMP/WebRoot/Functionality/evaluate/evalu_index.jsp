...
System.out.println("sdfsdddddddddddddddddd");
				...
				<div class="col-md-9 column" style="-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);border:#EDEFF0 solid;border-width:5px; background-color: #FFFFFF;">
					<h4 style="margin-top:10px;">
						...
						<span class="navbar-right" style="margin-right: 5px;">
							...
							%>
						    <button type="button" onclick="clearthismodelinfo();" class="btn btn-info btn-default btn-xs" data-toggle="modal" data-target="#modal-container-184701">新建评估表</button>
							<%
							}else{
							%>
							<button type="button"  disabled="disabled" class="btn btn-info btn-default btn-xs">新建评估表</button>
							<%
							}
							%>
						</span>    
					...
					<div  class="col-md-12 column" style="overflow-x:hidden; height:495px; ">
						...
						%>
							<tr >
								...
								if(memberinfo.getRole_num()==1||memberinfo.getRole_num()==2){
								%>
									<a href="openassessinfopage?id=<%=ac.getId() %>" style="text-decoration: none;">评估</a>&nbsp;&nbsp;
								<%
								}
								%>
									...
									<div class="modal-body"><br>
										<form class="form-inline" role="form">
										  <div class="form-group">
										    <label class=" control-label">评估表名：</label>
										   <!--  <div class="col-sm-6"> -->
										      <input type="text" class="form-control input-sm" style="width: 280px;" id="add_assessname" placeholder="请输入评估表名">
										    <!-- </div> -->
										  </div><br><br>
										
										<div>
										  <div class="form-group">
										  	<label  class=" control-label">评估区间：</label>
